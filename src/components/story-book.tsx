    ...
    return (
        <Carousel className="w-full max-w-xs md:max-w-5xl lg:max-w-7xl mx-auto bg-white shadow-xl rounded-lg overflow-hidden border-2 border-gray-200">
            <CarouselContent className="cursor-pointer">
                <CarouselItem>
                    <div className="flex flex-col md:flex-row items-center justify-center bg-gradient-to-r from-yellow-100 via-white to-yellow p-8 gap-x-4">
                ...
                {/* convert object into array, and render out content & image at it's current index */}
